...
public class Track implements Serializable {
    ...
    private int idDowload;
    private ObservableInt progessDownload = new ObservableInt();
    ...
    public int getIdDowload() {
        return idDowload;
    }

    public void setIdDowload(int idDowload) {
        this.idDowload = idDowload;
    }


    public ObservableInt getProgessDownload() {
        return progessDownload;
    }

    public void setProgessDownload(int progessDownload) {
        this.progessDownload.set(progessDownload);
    }
}
