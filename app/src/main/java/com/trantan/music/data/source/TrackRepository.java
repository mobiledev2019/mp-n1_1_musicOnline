...
public class TrackRepository implements TracksDataSource.Remote, TracksDataSource.Local {
    ...
    public void getFavoritesOnline(TracksDataSource.FavoriteCallback callback) {
        mRemoteDataSource.getFavoritesOnline(callback);
    }
    ...
    public void addFavorite(Track track, TracksDataSource.FavoriteCallback callback) {
        ...
        mRemoteDataSource.addFavorite(track, callback);
    }
    ...
    public void removeFavorite(Track track, TracksDataSource.FavoriteCallback callback) {
        ...
        mRemoteDataSource.removeFavorite(track, callback);
    }
    ...
    public void deleteFavoriteDb() {
        mLocalDataSource.deleteFavoriteDb();
    }
}
