package com.trantan.music.data.source.local;
...
import com.trantan.music.data.source.local.contract.FavoriteContract.FavoriteEntry;
import com.trantan.music.data.source.local.contract.SearchHistoryContract.SearchHistoryEntry;
...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void deleteFavoriteDb(){
        SQLiteDatabase db = getReadableDatabase();
        db.delete(FavoriteEntry.TABLE_FAVORITE, null, null);
    }
}
