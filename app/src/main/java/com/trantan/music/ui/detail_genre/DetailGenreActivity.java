...
import com.trantan.music.ui.search.SearchActivity;
...
//            DownloadTrackManager.getInstance(getApplicationContext()).download(mTrack);
            MyDownloadManager.getInstance(getApplicationContext()).download(mTrack);
        } else {
